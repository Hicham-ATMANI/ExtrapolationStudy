...
int Chi2TestPol1(int region){
	...
	TFile* Fin2Pol1   = new TFile("/sps/atlas/h/hatmani/Extrapolation/Extrapolation/2018/output-24-2Intervals-IntervaAddi.root");
	TFile* Fin3Pol1   = new TFile("/sps/atlas/h/hatmani/Extrapolation/Extrapolation/2018/output-24-3Intervals-IntervaAddi.root");
	TFile* Fin4Pol1   = new TFile("/sps/atlas/h/hatmani/Extrapolation/Extrapolation/2018/output-24-4Intervals-IntervaAddi.root");
	TFile* Fin5Pol1   = new TFile("/sps/atlas/h/hatmani/Extrapolation/Extrapolation/2018/output-24-5Intervals-IntervaAddi.root");
...
int Chi2TestPol2(int region){
        ...
        TFile* Flowmu     = new TFile("/sps/atlas/h/hatmani/rel21_Calibe/resultat_low-mu/Alpha_2017-24.root");
        TFile* Fin2Pol1   = new TFile("/sps/atlas/h/hatmani/Extrapolation/Extrapolation/2017/output-24-2Intervals-pol2.root");
        TFile* Fin3Pol1   = new TFile("/sps/atlas/h/hatmani/Extrapolation/Extrapolation/2017/output-24-3Intervals-pol2.root");
        TFile* Fin4Pol1   = new TFile("/sps/atlas/h/hatmani/Extrapolation/Extrapolation/2017/output-24-4Intervals-pol2.root");
        TFile* Fin5Pol1   = new TFile("/sps/atlas/h/hatmani/Extrapolation/Extrapolation/2017/output-24-5Intervals-pol2.root");
...
int PullPlotPol1(){
        ...
        TFile* Fin2Pol1    = new TFile("/sps/atlas/h/hatmani/Extrapolation/Extrapolation/2018/output-24-2Intervals-IntervaAddi.root");    TH1F*  Hin2Pol1    = (TH1F*)Fin2Pol1->Get("ExtraCorr");
        TFile* Fin3Pol1    = new TFile("/sps/atlas/h/hatmani/Extrapolation/Extrapolation/2018/output-24-3Intervals-IntervaAddi.root");    TH1F*  Hin3Pol1    = (TH1F*)Fin3Pol1->Get("ExtraCorr");
        TFile* Fin4Pol1    = new TFile("/sps/atlas/h/hatmani/Extrapolation/Extrapolation/2018/output-24-4Intervals-IntervaAddi.root");    TH1F*  Hin4Pol1    = (TH1F*)Fin4Pol1->Get("ExtraCorr");
        TFile* Fin5Pol1    = new TFile("/sps/atlas/h/hatmani/Extrapolation/Extrapolation/2018/output-24-5Intervals-IntervaAddi.root");    TH1F*  Hin5Pol1    = (TH1F*)Fin5Pol1->Get("ExtraCorr");
