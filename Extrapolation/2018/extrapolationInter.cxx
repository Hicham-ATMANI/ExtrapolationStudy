...
void ExtractHighmu5Intervals(){
	  ...
	  TFile* file0   = new TFile("/sps/atlas/h/hatmani/rel21_Calib_Pre/resultat_low-mu/Alpha_2018-24.root");
          TFile* file1   = new TFile("/sps/atlas/h/hatmani/Extrapolation/results18/5Intervals/Alpha-0.root");
          TFile* file2   = new TFile("/sps/atlas/h/hatmani/Extrapolation/results18/5Intervals/Alpha-1.root");
          TFile* file3   = new TFile("/sps/atlas/h/hatmani/Extrapolation/results18/5Intervals/Alpha-2.root");
          TFile* file4   = new TFile("/sps/atlas/h/hatmani/Extrapolation/results18/5Intervals/Alpha-3.root");
          TFile* file5   = new TFile("/sps/atlas/h/hatmani/Extrapolation/results18/5Intervals/Alpha-4.root");
	  ...
	  vectHist.push_back((TH1D*)file0->Get("measScale_alpha"));
          ...
          TFile* Fichier = new TFile("output-24-5Intervals-IntervaAddi.root","recreate");
...
void ExtractHighmu4Intervals(){
          ...
          TFile* file0   = new TFile("/sps/atlas/h/hatmani/rel21_Calib_Pre/resultat_low-mu/Alpha_2018-24.root");
          TFile* file1   = new TFile("/sps/atlas/h/hatmani/Extrapolation/results18/4Intervals/Alpha-0.root");
          TFile* file2   = new TFile("/sps/atlas/h/hatmani/Extrapolation/results18/4Intervals/Alpha-1.root");
          TFile* file3   = new TFile("/sps/atlas/h/hatmani/Extrapolation/results18/4Intervals/Alpha-2.root");
          TFile* file4   = new TFile("/sps/atlas/h/hatmani/Extrapolation/results18/4Intervals/Alpha-3.root");
          ...
          Double_t y[5] = {2,22.47,31.05,39.63,53.67};
          ...
          TFile* Fichier = new TFile("output-24-4Intervals-IntervaAddi.root","recreate");
          MAT->Write("colz"); Chi2->Write();
          for( int i=0 ; i < Nbins  ; i++){
          vectGraph[i]->Write();}
          Extra->Write();
...
void ExtractHighmu2Intervals(){
          ...
          TFile* Fichier = new TFile("output-24-2Intervals-IntervaAddi.root","recreate");
          MAT->Write("colz"); Chi2->Write();
          for( int i=0 ; i < Nbins  ; i++){
          vectGraph[i]->Write();}
          Extra->Write();
