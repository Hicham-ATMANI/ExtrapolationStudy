...
import os
import sys
sys.path.append(os.path.abspath("/sps/atlas/h/hatmani/Systh/PlotFunctions/python"))
...
def applyCorrection( directory ) :
    ...
    commandLine = 'MeasureScale --configFile /sps/atlas/h/hatmani/Systh/Template/ConfigFiles/AlphaOffSummer_15.boost  --noExtraction'
    commandLine+= ' --dataFileName  /sps/atlas/h/hatmani/PourHicham/nTuples/Systematics/data15.root' 
    commandLine+= ' --correctAlphaHistName DiffAlpha --correctAlphaFileName /sps/atlas/h/hatmani/Systh/PreRec/Results/AlphaOffSummer_15.root \n'
