...
namespace TrigMuonEff {
  ...
  typedef enum DataPeriod {
    ...
    period_2016_C = 10,	   per2016C = 10,
    period_2016_D1D3 = 11, per2016D1D3 = 11,
    period_2016_D4D8 = 12, per2016D4D8 = 12,
    period_2016_E = 13,	   per2016E = 13,
    period_2016_F = 14,	   per2016F = 14,
    period_2016_G = 15,	   per2016G = 15,
    period_2016_I = 16,	   per2016I = 16,
    period_2016_K = 17,	   per2016K = 17,
    period_2016_L = 18,	   per2016L = 18,
